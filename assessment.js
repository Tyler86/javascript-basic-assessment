...
*/
function outside (temp,humidity,cloudy){
 if (temp>80 && humidity > 40) return "I'm all sweat"
 else if(temp<40 && cloudy>60)return "I have icecicles"
 else if(temp>80 && humidity<40 && cloudy <20) return "I'm literally in the desert"
 else if(temp>80 || humidity >50 || cloudy > 50) return "Hmm, probably not"
 else return "I love outside"
}

// #16 Create a function called callerBack that takes in a function (holla) and a
// string parameter(back) and invokes it(holla) with the argument string(back) + ' back'."
